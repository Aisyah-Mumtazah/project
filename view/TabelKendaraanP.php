                        ...
                        <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                            <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                                ...
                                <button
                                    ...
                                    type="submit"><a href = "FormKendaraanP.php">Tambah Data</a>
                                </button>
                                <div class="p-3">
                                    <table class="table-responsive w-full rounded">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border w-1/5 px-4 py-2">ID Kendaraan</th>
                                                <th class="border w-1/5 px-4 py-2">Nama Kendaraan</th>
                                                <th class="border w-1/6 px-4 py-2">Jenis</th>
                                                <th class="border w-1/5 px-4 py-2">Nama Supir</th>
                                        ...
                                        <tbody>
                                            <?php
                                        $no=1;
                                        foreach($db->tampil_data_kendaraan() as $x){
                                            ?>
                                            <tr>
                                                <td class="border px-4 py-2"><?php echo $no++; ?></td>
                                                <td class="border px-4 py-2"><?php echo $x['id_kendaraan']; ?></td>
                                                <td class="border px-4 py-2"><?php echo $x['nama_kendaraan']; ?></td>
                                                <td class="border px-4 py-2"><?php echo $x['jenis']; ?></td>
                                                <td class="border px-4 py-2"><?php echo $x['nama_supir']; ?></td>
                                                <td class="border px-4 py-2">
                                                    <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white"
                                                        href="EditKendaraanP.php?idkendaraan=<?php echo $x['id_kendaraan']; ?>&aksi=edit">
                                                        <i class="fas fa-edit"></i></a>
                                                    <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-red-500"
                                                        href="../controller/ProsesKendaraanP.php?idkendaraan=<?php echo $x['id_kendaraan'] ?>&aksi=hapus">
