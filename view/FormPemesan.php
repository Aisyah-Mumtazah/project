                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                            ...
                            <div
                                ...
                                <div class="p-3">
                                    <form class="w-full" action="../controller/ProsesPemesanan.php?aksi=tambah"
                                        method="post">
                                        <div class="md:flex md:items-center mb-6">
                                            ...
                                            <div class="md:w-2/4">
                                                <input
                                                    ...
                                                    id="inline-full-name" type="text" name="idpesan">
                                            </div>
                                            <div class="md:w-1/4">
                                                <?php foreach($db->lastdata_pemesanan() as $c){ ?>
                                                <label
                                                    class="block text-gray-500 font-regular md:text-right mb-1 md:mb-0 pr-4"
                                                    for="idpesan">Sebelumnya:
                                                    <?php echo $c['id_pemesanan']; ?></label>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <div class="md:flex md:items-center mb-6">
                                        ...
                                        <div class="md:flex md:items-center mb-6">
                                            ...
                                            <div class="md:w-3/4">
                                                <input
                                                    class="bg-grey-200 appearance-none border-1 border-grey-200 rounded w-full py-2 px-4 text-grey-darker leading-tight focus:outline-none focus:bg-white focus:border-purple-light"
                                                    id="inline-full-name" type="text" name="alamat">
                                            </div>
                                        </div>
                                        <div class="md:flex md:items-center mb-6">
                                            <div class="md:w-1/4">
                                            ...
                                            <div class="md:w-3/4">
                                                <input
                                                    class="bg-grey-200 appearance-none border-1 border-grey-200 rounded w-full py-2 px-4 text-grey-darker leading-tight focus:outline-none focus:bg-white focus:border-purple-light"
                                                    id="inline-full-name" type="text" name="notelp">
                                            </div>
                                        </div>
