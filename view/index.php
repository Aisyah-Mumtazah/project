...
<div class="mx-auto bg-grey-400">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <header class="bg-nav" style="position: fixed; width:100%;">
                    ...
                    <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                       ...
                       <div class="rounded overflow-hidden shadow bg-white mx-2 w-full">
                            <div class="px-6 py-2 border-b border-light-grey">
                                <div class="font-bold text-grey-darkest">Layanan Travel yang Tersedia</div><br>
                                <o1>
                                    <li>Sarolangun-Pekanbaru</li>
                                    <li>Sarolangun-Muara Bungo</li>
                                    <li>Sarolangun-Dharmasraya</li>
                                    <li>Sarolangun-Dumai</li>
                                </o1>
                            </div>
                        </div>
                        ...
                        <div class="rounded overflow-hidden shadow bg-white mx-2 w-full">
                            <div class="px-6 py-2 border-b border-light-grey">
                                <div class="font-bold text-grey-darkest">Tentang</div><br>
                                <div class ="rounded m-3">
                                    ...
                                    dapat merasakan kenyamanan dalam menikmati layanan travel yang kami sediakan. </div>
                                </div>
                            </div>
                        </div>
        ...
        <footer class="bg-grey-darkest text-white p-2">
            <div class="flex flex-1 mx-auto">&copy; 2021 Traveli</div>
            <div class="flex flex-1 mx-auto">Created by: Kelompok 2 BPWL</div>
        </footer>
        <!--/footer-->
