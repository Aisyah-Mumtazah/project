                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                            ...
                            <div
                                ...
                                <div class="p-3">
                                    <form class="w-full" action="../controller/ProsesKendaraan.php?aksi=tambah"
                                        method="post">
                                        <div class="md:flex md:items-center mb-6">
                                            ...
                                            <div class="md:w-3/4">
                                                <input
                                                    ...
                                                    id="inline-full-name" type="text" name="idkendaraan">
                                            </div>
                                        </div>
                                        <div class="md:flex md:items-center mb-6">
                                            <div class="md:w-1/4">
                                        ...
                                        <div class="md:flex md:items-center mb-6">
                                            ...
                                            <div class="md:w-3/4">
                                                <input
                                                    class="bg-grey-200 appearance-none border-1 border-grey-200 rounded w-full py-2 px-4 text-grey-darker leading-tight focus:outline-none focus:bg-white focus:border-purple-light"
                                                    id="inline-full-name" type="text" name="jenis">
                                            </div>
                                        </div>
                                        <div class="md:flex md:items-center mb-6">
                                            <div class="md:w-1/4">
                                            ...
                                            <div class="md:w-3/4">
                                                <input
                                                    class="bg-grey-200 appearance-none border-1 border-grey-200 rounded w-full py-2 px-4 text-grey-darker leading-tight focus:outline-none focus:bg-white focus:border-purple-light"
                                                    id="inline-full-name" type="text" name="supir">
                                            </div>
                                        </div>
